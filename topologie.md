...
Sieć fizyczna to fizyczne ułorzenie kabli, urządzeń, i połączeń.Przykłady:
    -**Topologia magistrali**(Bus): jest to topologia w której wszystkie urządzenia w sieci są 
    ...
    -**Topologia pierścienia**(Ring): jest to topologia w której urządzenia są połączone w zamkniętą 
    ...
    -**Topologia gwiazdy**(Star): jest to topologia w której wszystkie urządzenia w sieci są połączone z jednym 
